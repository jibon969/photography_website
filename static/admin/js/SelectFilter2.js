    ...
    window.SelectFilter = {
        init: function(field_id, field_name, is_stacked) {
            ...
            for (var i = 0; i < ps.length; i++) {
                ...
                } else if (ps[i].className.indexOf("how_to_send_email") !== -1) {
                    // Move how_to_send_email text up to the top so it isn't below the select
            ...
            quickElement(
                ...
                'class', 'how_to_send_email how_to_send_email-tooltip how_to_send_email-icon',
                'title', interpolate(
                    gettext(
            ...
            quickElement(
                ...
                'class', 'how_to_send_email-tooltip search-label-icon',
